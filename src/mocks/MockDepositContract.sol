...
interface IMockDepositContract {
...
contract MockDepositContract is IMockDepositContract, ERC165 {
    ...
    function supportsInterface(bytes4 interfaceId) external pure override returns (bool) {
        return interfaceId == type(ERC165).interfaceId || interfaceId == type(IMockDepositContract).interfaceId;
    }
    ...
    /**
     * @dev skip this contract from testing
     */
