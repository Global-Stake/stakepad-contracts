 ...
 * @notice V1 of StakePad contracts for DEMO
 */
contract TestStakePadV1 is IStakePad, Initializable, UUPSUpgradeable, OwnableUpgradeable {
     ...
     */
    function fundValidators(StakePadUtils.BeaconDepositParams[] calldata DepositDataArray) external payable {
        require(msg.value > 0, "StakePadV1: incorrect amount of ETH");
        for (uint256 i = 0; i < DepositDataArray.length; ++i) {
            ...
            beaconDeposit.deposit{value: msg.value / DepositDataArray.length}(
                DepositData.pubkey,
